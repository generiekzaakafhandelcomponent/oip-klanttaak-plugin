...
const oipKlanttaakPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      'configuration.finalizerProcess': 'Het taak-afrondingsproces kan of een generiek (systeem) process zijn of een case specifiek proces.',
    ...
    en: {
      ...
      'configuration.finalizerProcess': 'The task completion process can be either a generic (system) process or a case specific process.',
    ...
    de: {
      ...
      'configuration.finalizerProcess': 'Der Prozess zur Aufgabenerledigung kann entweder ein generischer (System-)Prozess oder ein fallspezifischer Prozess sein.',
