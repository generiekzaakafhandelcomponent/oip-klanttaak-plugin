...
const oipKlanttaakPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      description: 'Delegeer gebruikerstaken naar het Open Inwoner Platform (OIP) portaal zodat deze opgepakt kunnen worden door de gebruikers van dat portaal.',
      ...
      'delegate-task': 'Gebruikerstaak delegeren',
      ...
      'complete-delegated-task': 'Afgeronde gebruikerstaak verwerken',
      'toggle.ja': 'Ja',
      'toggle.nee': 'Nee',
    },
    en: {
      ...
      'delegate-task': 'Delegate user task',
      ...
      'delegateTask.koppelingVanToepassing': '',
      'delegateTask.koppelingRegistratie': '',
      'delegateTask.koppelingRegistratieTooltip': '',
      'delegateTask.koppelingIdentifier': '',
      'delegateTask.koppelingIdentifierTooltip': '',
      'delegateTask.verloopdatum': 'Expiration date',
      'delegateTask.verloopdatumTooltip': 'The date and time when the task expires',
      'complete-delegated-task': 'Complete delegated task',
      'toggle.ja': 'Yes',
      'toggle.nee': 'No',
    },
    de: {
      title: 'Open Inwoner Platform (OIP) - Klanttaak',
      description: 'Delegieren Sie Benutzeraufgaben an das Open Inwoner Platform (OIP) Portal, damit diese von den Benutzern dieses Portals übernommen werden können.',
      ...
      'delegate-task': 'Benutzeraufgabe delegieren',
      ...
      'complete-delegated-task': 'Abgeschlossene Benutzeraufgabe verarbeiten',
      'toggle.ja': 'Ja',
      'toggle.nee': 'Nein',
    }
  }
